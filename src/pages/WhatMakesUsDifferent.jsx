  ...
  return (
    <section className="bg-white py-20 px-6">
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold text-blue-700">What Makes Us Different</h2>
        <p className="mt-4 text-lg text-yellow-700 max-w-2xl mx-auto">
      ...
      <div className="space-y-12 max-w-5xl mx-auto">
        {features.map((feature, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className={`flex flex-col sm:flex-row items-center gap-6 ${index % 2 === 0 ? '' : 'sm:flex-row-reverse'}`}
          >
            <div className={`text-4xl sm:text-5xl ${feature.accent}`}>
              <feature.icon />
            </div>
